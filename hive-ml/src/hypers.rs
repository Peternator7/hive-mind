...
pub const TRAINING_PLAY_VS_RANDOM_PCT: f64 = 0.10;
pub const TRAINING_PLAY_RANDOM_MOVE_FREQUENCY: f64 = 0.01;
...
pub const TARGET_FRAMES_PER_BATCH: usize = 16_384;
...
pub const PENALTY_FOR_TIMING_OUT: f64 = 0.50;
