...
pub const DISTILLATION_LAYER_SIZE: i64 = 8;
...
pub const TARGET_FRAMES_PER_SAMPLING: usize = 3_000;

/// The number of turns after which we cancel a game.
pub const MAX_TURNS_PER_GAME: usize = 500;
pub const MAX_TURNS_PER_GAME_DECREASE_PER_EPOCH: usize = 0;
pub const MIN_MAX_TURNS_PER_GAME: usize = 500;
...
pub const TARGET_FRAMES_PER_GAME: usize = 20;
...
pub const NOVELTY_LOSS_RATIO: f64 = 1.0;
...
pub const PENALTY_FOR_TIMING_OUT: f64 = 2.0;
